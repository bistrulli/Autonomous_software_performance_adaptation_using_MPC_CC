...
trackError=sum(abs(x0(3,2:end)-75))+sum(abs([1,0,1,1]*x0))/100;

actuationCost=sum(vecCost*x_inst(:,1:end))+sum(vecCost*u_inst(:,end)*spoolTime)%+sum(abs(x_inst(:,1:end-1)-x_inst(:,2:end)),'all')/100;
